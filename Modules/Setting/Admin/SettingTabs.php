...
class SettingTabs extends Tabs
{
    ...
    {
        return tap(new Tab('tracking_url', trans('setting::settings.tabs.tracking_url')), function (Tab $tab) {
            $tab->weight(50);
            ...
            $tab->view('setting::admin.settings.tabs.tracking_url');
        });
    }
