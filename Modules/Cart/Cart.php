...
class Cart extends DarryldecodeCart implements JsonSerializable
{
   ...
   // public function customShippingPrice($dPin){
   //    $url = 'https://track.delhivery.com/api/kinko/v1/invoice/charges/.json?ss=DTO&md=S&cgm='.$this->totalWeight().'&o_pin=160021&d_pin='.$dPin; 
   //    $header = array();
   ...
   // }
    ...
    public function addShippingMethod($value)
    {
    ...
    public function totalWeight()
    {
        return $this->items()->sum(function ($cartItem) {
            return $cartItem->product->weight;
        });
    }
    ...
    public function toArray()
    {
        return [
            ...
            // 'customShippingPrice' => $this->customShippingPrice()
        ];
    }

    public function jsonSerialize()
    {
         // return $this->customShippingPrice();
        return $this->toArray();
    }
