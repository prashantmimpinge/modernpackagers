<script type="text/html" id="flash-sale-product-template">
    <div class="panel">
        <div class="panel-header clearfix">
            ...
            {{ trans('queryproduct::flash_sales.form.flash_sale_product') }}
                ...
                <div class="col-sm-12">
                    <div class="form-group">
                        <label for="products-<%- productPanelNumber %>-product-id">
                            {{ trans('queryproduct::attributes.product') }}<span class="m-l-5 text-red">*</span>
                        </label>
                ...
                <div class="col-sm-6 col-xs-12">
                    <div class="form-group">
                        <label for="products-<%- productPanelNumber %>-campaign-end">
                            {{ trans('queryproduct::attributes.end_date') }}<span class="m-l-5 text-red">*</span>
                        </label>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="form-group">
                        <label for="products-<%- productPanelNumber %>-price">
                            {{ trans('queryproduct::attributes.price') }}<span class="m-l-5 text-red">*</span>
                        </label>
                ...
                <div class="col-sm-3 col-xs-6">
                    <div class="form-group">
                        <label for="products-<%- productPanelNumber %>-qty">
                            {{ trans('queryproduct::attributes.quantity') }}<span class="m-l-5 text-red">*</span>
                        </label>
